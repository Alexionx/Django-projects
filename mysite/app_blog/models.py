...
class Article(models.Model):
    ...
    category = models.ForeignKey(Category, related_name="news", on_delete=models.CASCADE, blank=True, null=True)
...
class ArticleImage(models.Model):
    article = models.ForeignKey(Article, on_delete=models.CASCADE, related_name="images", verbose_name="Стаття")
